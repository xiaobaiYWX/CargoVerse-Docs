...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:vbs/biopod/vbs_biopod_【interface】_s` |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:vbs/biopod/vbs_biopod_【interface】_m` |
