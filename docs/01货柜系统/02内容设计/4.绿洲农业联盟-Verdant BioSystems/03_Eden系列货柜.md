...
| 产品系列 | 规格 | 接口 | 定位 | 特点 |
| --- | --- | --- | --- | --- |
| Eden 系列 | X/XL | 【待确定】 | 生态模块舱 | 水培；温室；长期部署 |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:vbs/eden/vbs_eden_【interface】_x` |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:vbs/eden/vbs_eden_【interface】_xl` |
