...
| `wood` | 木材 | × | — | 无 |  |
| `stone` | 石材 | × | — | 无 |  |
| `fuel_resource` | 能源原料 | √ | M/L | `flammable`<br>`radioactive`<br>`cold_proof` | 隔离容器和安全阀组适合常规能源物资，可运输燃料、电池材料和高能介质。 |
| `textile` | 纺织与轻工业品 | × | — | 无 |  |
| `security` | 安防与武装设备 | × | — | 无 |  |
| `component` | 工业零件 | × | — | `fragile` |  |
| `machinery` | 机械设备 | × | — | `keep_upright`<br>`fragile` |  |
| `electronics` | 电子设备 | × | — | `moisture_proof`<br>`fragile` |  |
| `chemical` | 化工材料 | √ | M/L | `radioactive` | 隔离容器和安全阀组适合常规能源物资，可运输工业试剂、化工原料和特殊介质。 |
| `construction` | 建筑材料 | × | — | 无 |  |
...
> 通过醒目的危险标识、分区隔离和安全阀组承运常规燃料与能源材料，是赫利俄斯能源连接聚落、电站和工业设施的标准供应货柜。该 M 型在容量、重量与周转效率之间取得平衡，是系列中的常用主力规格。
...
| `blocked_affixes`   | 屏蔽词条         | `radioactive` `flammable` `moisture_proof`                                                                                                                                                              |
| `base_affixes`      | 货柜基础词条       | `height_limit`                                                                                                                                                                                          |
...
> 通过醒目的危险标识、分区隔离和安全阀组承运常规燃料与能源材料，是赫利俄斯能源连接聚落、电站和工业设施的标准供应货柜。该 L 型扩大了承载空间并强化受力结构，面向批量货流和大型运输平台。
