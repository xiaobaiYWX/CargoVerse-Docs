...
| 产品系列    | 规格    | 接口  | 定位     | 特点                    |
| ------- | ----- | --- | ------ | --------------------- |
| Titan系列 | L/X/XL | HD  | 重型工业运输 | 高承载；加强结构；通常更重运输的货物也更多 |
...
| `ore`               | 矿石资源    |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输原矿和精炼矿料。      |
| `wood`              | 木材      |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输原木、板材和木构件。    |
| `stone`             | 石材      |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输石料和砖材。        |
| `fuel_resource`     | 能源原料    |  √   | L/X/XL | `flammable`<br>`radioactive`<br>`cold_proof` | 强化承载框架适合重型运输，可运输燃料和能源材料。      |
| `textile`           | 纺织与轻工业品 |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输布匹和轻工业制品。     |
| `security`          | 安防与武装设备 |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输武器、装甲和安防设备。   |
| `component`         | 工业零件    |  √   | L/X/XL | `fragile` | 强化承载框架适合重型运输，可运输机械零件和工业组件。    |
| `machinery`         | 机械设备    |  √   | L/X/XL | `keep_upright`<br>`fragile` | 强化承载框架适合重型运输，可运输机床和工程机械。      |
| `electronics`       | 电子设备    |  √   | L/X/XL | `moisture_proof`<br>`fragile` | 强化承载框架适合重型运输，可运输传感器、控制器和计算设备。 |
| `chemical`          | 化工材料    |  ×   | —     | `radioactive` |                               |
| `construction`      | 建筑材料    |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输建材和设施配套材料。    |
| `structural_module` | 大型结构组件  |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输预制舱段和大型结构件。   |
| `supplies`          | 生活补给    |  √   | L/X/XL | 无 | 强化承载框架适合重型运输，可运输食品、工具和日常补给。   |
...
| 参数                  | 名称           | 内容                                                                                                                                                                                                        |
| ------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `template` | 货柜结构ID | `cargoverse:cargo/aui/titan/aui_titan_hd_l` |
...
| ---------------------- | :--------------: | :-------------------------: | :------------------------: | :--------------------------------: | :------------------------------: | :--------------------------------: |
| `ore`                  |        3         | 2.5 |            1.2             |                1.6                 |               1.4                |                1.4                 |
| `wood`                 |        3         | 2.2 |            1.2             |                1.6                 |               1.4                |                1.4                 |
| `stone`                |        3         | 2.2 |            1.2             |                1.6                 |               1.4                |                1.4                 |
| `fuel_resource`        |        3         | 2.0 |            1.2             |                1.6                 |               1.4                |                1.4                 |
| `textile`              |        1         | 2.2 |            1.2             |                1.4                 |               1.2                |                1.3                 |
| `security`             |        1         | 2.5 |            1.2             |                1.4                 |               1.2                |                1.3                 |
| `component`            |        3         | 2.5 |            1.2             |                1.4                 |               1.2                |                1.3                 |
| `machinery`            |        3         | 2.2 |            1.2             |                1.7                 |               1.4                |                1.6                 |
| `electronics`          |        1         | 2.2 |            1.2             |                1.4                 |               1.2                |                1.3                 |
| `construction`         |        1         | 2.5 |            1.2             |                1.4                 |               1.2                |                1.3                 |
| `structural_module`    |        3         | 2.2 |            1.2             |                1.6                 |               1.4                |                1.6                 |
| `supplies`             |        1         | 2.2 |            1.2             |                1.4                 |               1.2                |                1.3                 |
...
| 参数                  | 名称           | 内容                                                                                                                                                                                                                   |
| ------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `template` | 货柜结构ID | `cargoverse:cargo/aui/titan/aui_titan_hd_x` |
...
| 参数                  | 名称           | 内容                                                                                                                                                                                                                    |
| ------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `template` | 货柜结构ID | `cargoverse:cargo/aui/titan/aui_titan_hd_xl` |
