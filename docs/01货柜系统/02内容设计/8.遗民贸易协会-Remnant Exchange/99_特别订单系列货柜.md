...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:cargo/rex/relic/rex_relic_lm_sp` |
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| `luxury` | 4 | 1.6 | 1.9 | 0.4 | 1.7 | 1.45 |
| `research_sample` | 5 | 1.6 | 2.0 | 0.3 | 1.8 | 1.6 |
| `data` | 4 | 1.6 | 1.8 | 0.45 | 1.6 | 1.4 |
| `experimental` | 5 | 1.6 | 2.1 | 0.25 | 1.9 | 1.65 |
...
| 产品系列        | 规格  | 接口  | 定位     | 特点       |
| ----------- | --- | --- | ------ | -------- |
| Blackbox 系列 | SP  | LM  | 未知封装模块 | 信息未知；高价值 |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:cargo/rex/blackbox/rex_blackbox_lm_sp` |
...
| `cargo_type` | `weight` | `mass_modifier` | `price_modifier` | `cargo_units_modifier` | `license_modifier` | `prosperity_modifier` |
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| `luxury` | 2 | 1.8 | 2.0 | 0.35 | 1.8 | 1.5 |
| `research_sample` | 3 | 1.8 | 2.15 | 0.25 | 1.95 | 1.7 |
| `data` | 4 | 1.8 | 2.1 | 0.25 | 1.9 | 1.6 |
| `experimental` | 5 | 2.1 | 2.3 | 0.2 | 2.0 | 1.8 |
