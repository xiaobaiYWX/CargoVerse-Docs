...
| 产品系列 | 规格 | 接口 | 定位 | 特点 |
| --- | --- | --- | --- | --- |
| Bastion 系列 | L/X | 【待确定】 | 防御物资模块 | 装甲；安全 |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:bds/bastion/bds_bastion_【interface】_l` |
...
| 参数 | 名称 | 内容 |
| --- | --- | --- |
| `template` | 货柜结构ID | `cargoverse:bds/bastion/bds_bastion_【interface】_x` |
