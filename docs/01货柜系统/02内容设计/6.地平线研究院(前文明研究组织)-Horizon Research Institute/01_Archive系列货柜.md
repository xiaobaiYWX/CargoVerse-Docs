...
| 产品系列       | 规格  | 接口  | 定位    | 特点       |
| ---------- | --- | --- | ----- | -------- |
| Archive 系列 | S/M | SI  | 数据存储舱 | 高安全；数据保护 |
...
| `electronics` | 电子设备 | √ | S/M | `moisture_proof`<br>`fragile` | 屏蔽外壳和访问控制适合数据载体，可运输传感器、控制器和计算设备。 |
...
| `data` | 数据资源 | √ | S/M | `cold_proof`<br>`fragile`<br>`moisture_proof` | 屏蔽外壳和访问控制适合数据载体，可运输数据服务器、存储阵列和加密资料。 |
| `experimental` | 实验品 | × | — | 无 |  |
...
### HRI Archive 数据存储舱 S 型

> 采用黑色屏蔽外壳、冗余供能和多重访问控制保护加密记录、研究终端及珍贵数据载体，承担地平线研究院的知识保存任务。该 S 型强调便携与快速交接，适合小批量货物及小型运输平台。
...
| 参数                  | 名称           | 内容                                                                                                                                                                                              |
| ------------------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `template`          | 货柜结构ID       | `cargoverse:cargo/hri/archive/hri_archive_si_s`                                                                                                                                                 |
| `display_name`      | 显示名称         | `HRI Archive 数据存储舱 S 型`                                                                                                                                                                         |
| `cargo_description` | 货柜描述         | `§lHRI Archive 数据存储舱 S 型\n§r§7采用黑色屏蔽外壳、冗余供能和多重访问控制保护加密记录、研究终端及珍贵数据载体，承担地平线研究院的知识保存任务。该 S 型强调便携与快速交接，适合小批量货物及小型运输平台。\n§r§l制造商：Horizon Research Institute\n§r§l系列：Archive Series\n§r§l接口：SI 滑轨接口` |
| `currency_id`       | 交易物品ID       | `cargoverse:enderite`                                                                                                                                                                           |
| `max_owned`         | 每个玩家的同时最大持有量 | 10                                                                                                                                                                                              |
| `cargo_level`       | 货柜等级         | `S`                                                                                                                                                                                             |
| `max_integrity`     | 最大完整性        | 90                                                                                                                                                                                              |
| `blocked_affixes`   | 屏蔽词条         | `moisture_proof` `fragile` `keep_upright` `light_sensitive`                                                                                                                                     |
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| `electronics` | 3 | 1.15 | 1.35 | 0.75 | 1.3 | 1.2 |
| `data` | 5 | 1.15 | 1.75 | 0.4 | 1.6 | 1.4 |

---

## HRI-Archive-SI-M

### HRI Archive 数据存储舱 M 型

> 采用黑色屏蔽外壳、冗余供能和多重访问控制保护加密记录、研究终端及珍贵数据载体，承担地平线研究院的知识保存任务。该 M 型在容量、重量与周转效率之间取得平衡，是系列中的常用主力规格。
...
| 参数                  | 名称           | 内容                                                                                                                                                                                                   |
| ------------------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `template`          | 货柜结构ID       | `cargoverse:cargo/hri/archive/hri_archive_si_m`                                                                                                                                                      |
| `display_name`      | 显示名称         | `HRI Archive 数据存储舱 M 型`                                                                                                                                                                              |
| `cargo_description` | 货柜描述         | `§lHRI Archive 数据存储舱 M 型\n§r§7采用黑色屏蔽外壳、冗余供能和多重访问控制保护加密记录、研究终端及珍贵数据载体，承担地平线研究院的知识保存任务。该 M 型在容量、重量与周转效率之间取得平衡，是系列中的常用主力规格。\n§r§l制造商：Horizon Research Institute\n§r§l系列：Archive Series\n§r§l接口：SI 滑轨接口` |
| `currency_id`       | 交易物品ID       | `cargoverse:enderite`                                                                                                                                                                                |
| `max_owned`         | 每个玩家的同时最大持有量 | 10                                                                                                                                                                                                   |
| `cargo_level`       | 货柜等级         | `M`                                                                                                                                                                                                  |
| `max_integrity`     | 最大完整性        | 90                                                                                                                                                                                                   |
