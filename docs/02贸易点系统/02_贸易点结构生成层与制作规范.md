...
![道路结构池示意图](../assets/images/tradepoint/road_pool.png)
### 5.2 固定建筑池
...
![固定建筑结构池示意图](../assets/images/tradepoint/tradepoint_fixed_buildings.png)
### 5.3 随机建筑池
...
不要等全部模板保存后再猜测生成方向。
![贸易点结构生成方向示意图](../assets/images/tradepoint/tradepoint_Generation_direction.png)
### 7.2 保存范围
...
![贸易点结构组成示意图](../assets/images/tradepoint/tradepoint_Structure.png)
### 7.3 道路与建筑的拆分
...
![贸易点模板池示意图](../assets/images/tradepoint/tradepoint_Template_pool1.png)
### 7.4 投影方式
