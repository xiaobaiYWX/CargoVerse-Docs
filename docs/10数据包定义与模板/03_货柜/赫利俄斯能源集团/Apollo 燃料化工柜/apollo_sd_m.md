# HEC Apollo 燃料化工柜 M 型

[赫利俄斯能源集团](<../README.md>) → [Apollo 燃料化工柜](<README.md>) → M 型
...
| 项目 | 内容 |
| --- | --- |
| 完整型号 | `HEC-Apollo-SD-M` |
| 资源 ID | `cargoverse:hec/apollo_sd_m` |
| 定义文件 | [apollo_sd_m.json](<../../../../../../CargoVerse-NeoForge-1.21.1/src/main/resources/data/cargoverse/cargo_containers/hec/apollo_sd_m.json>) |
...
**正式模板已提供。** 当前引用：`cargoverse:cargo/hec/apollo/hec_apollo_sd_m`。结构文件存在，尚未在本轮重新验证游戏内碰撞、接口与实际质量。

[当前 NBT 文件](<../../../../../../CargoVerse-NeoForge-1.21.1/src/main/resources/data/cargoverse/structure/cargo/hec/apollo/hec_apollo_sd_m.nbt>) · [缺失模板总表](<../../缺失结构模板.md>)
...
{
  "schema_version": 1,
  "template": "cargoverse:cargo/hec/apollo/hec_apollo_sd_m",
  "manufacturer": "cargoverse:hec",
  "display_name": "HEC Apollo 燃料化工柜 M 型",
  "description": "§lHEC Apollo 燃料化工柜 M 型\n§r§7面向燃料与工业化学材料供应，使用防火、防潮和固定设计满足能源运输需求。\n§r§l制造商：赫利俄斯能源集团 / Helios Energy Corporation\n§r§l系列：Apollo 燃料化工柜",
  "size_class": "M",
