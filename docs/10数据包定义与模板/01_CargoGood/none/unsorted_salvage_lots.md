...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:none/unsorted_salvage_lots` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/none/unsorted_salvage_lots.json` |
| Schema 版本 | 1 |
| CargoClass | `none` |
| 显示名称 | 未分拣打捞包 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/none/unsorted_salvage_lots.png`（32×32 RGBA PNG） |
| 科技等级 | 1 |
| 标签 | `ingredient.none.unsorted_salvage_lots`、`reserved_unidentified` |
