...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:none/unprovenanced_sealed_crates` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/none/unprovenanced_sealed_crates.json` |
| Schema 版本 | 1 |
| CargoClass | `none` |
| 显示名称 | 来源不明封存箱 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/none/unprovenanced_sealed_crates.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.none.unprovenanced_sealed_crates`、`reserved_unidentified` |
