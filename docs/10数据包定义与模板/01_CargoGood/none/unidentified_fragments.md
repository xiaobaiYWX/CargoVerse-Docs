...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:none/unidentified_fragments` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/none/unidentified_fragments.json` |
| Schema 版本 | 1 |
| CargoClass | `none` |
| 显示名称 | 未鉴定残件 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/none/unidentified_fragments.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.none.unidentified_fragments`、`reserved_unidentified` |
