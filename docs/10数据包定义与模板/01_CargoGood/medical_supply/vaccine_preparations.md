...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:medical_supply/vaccine_preparations` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/medical_supply/vaccine_preparations.json` |
| Schema 版本 | 1 |
| CargoClass | `medical_supply` |
| 显示名称 | 疫苗制剂 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/medical_supply/vaccine_preparations.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.medical_supply.vaccine_preparations` |
