...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:medical_supply/first_aid_medicines` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/medical_supply/first_aid_medicines.json` |
| Schema 版本 | 1 |
| CargoClass | `medical_supply` |
| 显示名称 | 急救药剂 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/medical_supply/first_aid_medicines.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.medical_supply.first_aid_medicines` |
