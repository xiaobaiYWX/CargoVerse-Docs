...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:electronics/avionics_controllers` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/electronics/avionics_controllers.json` |
| Schema 版本 | 1 |
| CargoClass | `electronics` |
| 显示名称 | 航电控制器 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/electronics/avionics_controllers.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.electronics.avionics_controllers` |
