...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:machinery/precision_machine_tools` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/machinery/precision_machine_tools.json` |
| Schema 版本 | 1 |
| CargoClass | `machinery` |
| 显示名称 | 精密机床 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/machinery/precision_machine_tools.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.machinery.precision_machine_tools` |
