...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:machinery/ore_crushers` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/machinery/ore_crushers.json` |
| Schema 版本 | 1 |
| CargoClass | `machinery` |
| 显示名称 | 矿石破碎机 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/machinery/ore_crushers.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.machinery.ore_crushers` |
