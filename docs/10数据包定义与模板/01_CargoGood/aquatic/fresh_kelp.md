...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:aquatic/fresh_kelp` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/aquatic/fresh_kelp.json` |
| Schema 版本 | 1 |
| CargoClass | `aquatic` |
| 显示名称 | 鲜采食用海带 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/aquatic/fresh_kelp.png`（32×32 RGBA PNG） |
| 科技等级 | 1 |
| 标签 | `ingredient.aquatic.fresh_kelp` |
...
| 词条 ID | 参数 |
| --- | --- |
| `cargoverse:time_limit` | `time_tick` = 96000 |

## 内容定位与投放

海带养殖点→食品与化工加工；低价高吞吐；限时宽松
