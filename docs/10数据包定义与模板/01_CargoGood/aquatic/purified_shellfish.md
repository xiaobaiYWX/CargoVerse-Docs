...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:aquatic/purified_shellfish` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/aquatic/purified_shellfish.json` |
| Schema 版本 | 1 |
| CargoClass | `aquatic` |
| 显示名称 | 净化鲜贝 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/aquatic/purified_shellfish.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.aquatic.purified_shellfish` |
...
贝类净化站→餐饮市场；用途为食材，不作为繁殖活体；限时、勿倒置
