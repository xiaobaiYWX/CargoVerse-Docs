...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:aquatic/chilled_river_fish` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/aquatic/chilled_river_fish.json` |
| Schema 版本 | 1 |
| CargoClass | `aquatic` |
| 显示名称 | 冰鲜河鱼 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/aquatic/chilled_river_fish.png`（32×32 RGBA PNG） |
| 科技等级 | 1 |
| 标签 | `ingredient.aquatic.chilled_river_fish` |
