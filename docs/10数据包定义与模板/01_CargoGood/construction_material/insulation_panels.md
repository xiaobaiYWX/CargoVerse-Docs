...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:construction_material/insulation_panels` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/construction_material/insulation_panels.json` |
| Schema 版本 | 1 |
| CargoClass | `construction_material` |
| 显示名称 | 保温板材 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/construction_material/insulation_panels.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.construction_material.insulation_panels` |
