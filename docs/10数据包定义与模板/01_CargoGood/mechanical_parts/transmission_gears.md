...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:mechanical_parts/transmission_gears` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/mechanical_parts/transmission_gears.json` |
| Schema 版本 | 1 |
| CargoClass | `mechanical_parts` |
| 显示名称 | 标准传动齿轮 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/mechanical_parts/transmission_gears.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.mechanical_parts.transmission_gears`、`mechanical_drive_part` |
