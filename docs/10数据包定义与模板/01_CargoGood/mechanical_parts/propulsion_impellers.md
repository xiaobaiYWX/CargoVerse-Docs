...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:mechanical_parts/propulsion_impellers` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/mechanical_parts/propulsion_impellers.json` |
| Schema 版本 | 1 |
| CargoClass | `mechanical_parts` |
| 显示名称 | 推进器叶轮 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/mechanical_parts/propulsion_impellers.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.mechanical_parts.propulsion_impellers` |
