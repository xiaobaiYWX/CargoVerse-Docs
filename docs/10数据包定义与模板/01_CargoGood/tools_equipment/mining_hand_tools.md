...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:tools_equipment/mining_hand_tools` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/tools_equipment/mining_hand_tools.json` |
| Schema 版本 | 1 |
| CargoClass | `tools_equipment` |
| 显示名称 | 矿务手工具 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/tools_equipment/mining_hand_tools.png`（32×32 RGBA PNG） |
| 科技等级 | 1 |
| 标签 | `ingredient.tools_equipment.mining_hand_tools` |
