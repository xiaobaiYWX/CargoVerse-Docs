...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:anomalous_cargo/contained_void_mixture` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/anomalous_cargo/contained_void_mixture.json` |
| Schema 版本 | 1 |
| CargoClass | `anomalous_cargo` |
| 显示名称 | 桶装虚空混合物 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/anomalous_cargo/contained_void_mixture.png`（32×32 RGBA PNG） |
| 科技等级 | 5 |
| 标签 | `ingredient.anomalous_cargo.contained_void_mixture` |
...
虚空提取设施→相位研究、专用加工设施；异常实体物质运输；避光、勿倒置为候选约束
