...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:valuables/artisan_jewelry` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/valuables/artisan_jewelry.json` |
| Schema 版本 | 1 |
| CargoClass | `valuables` |
| 显示名称 | 精工饰品 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/valuables/artisan_jewelry.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.valuables.artisan_jewelry` |
...
- 本轮采用持续周转：来源初始 1 t、容量 3 t、日补 1 t；主要买方初始 0、容量 3 t、日耗 0.25 t、满库停止收购。已同步资源表，自然结构待补。
