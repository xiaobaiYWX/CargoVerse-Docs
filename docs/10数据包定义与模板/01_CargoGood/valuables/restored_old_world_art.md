...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:valuables/restored_old_world_art` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/valuables/restored_old_world_art.json` |
| Schema 版本 | 1 |
| CargoClass | `valuables` |
| 显示名称 | 修复旧世艺术品 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/valuables/restored_old_world_art.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.valuables.restored_old_world_art` |
