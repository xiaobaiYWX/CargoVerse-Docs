...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:vehicle/port_tractors` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/vehicle/port_tractors.json` |
| Schema 版本 | 1 |
| CargoClass | `vehicle` |
| 显示名称 | 港区牵引车 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/vehicle/port_tractors.png`（32×32 RGBA PNG） |
| 科技等级 | 2 |
| 标签 | `ingredient.vehicle.port_tractors` |
