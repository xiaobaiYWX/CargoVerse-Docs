...
| 项目 | 内容 |
| --- | --- |
| 资源 ID | `cargoverse:vehicle/light_patrol_boats` |
| JSON 文件 | `src/main/resources/data/cargoverse/cargo_goods/vehicle/light_patrol_boats.json` |
| Schema 版本 | 1 |
| CargoClass | `vehicle` |
| 显示名称 | 轻型巡逻艇 |
| UI 图标 | `cargoverse:textures/gui/cargo_goods/vehicle/light_patrol_boats.png`（32×32 RGBA PNG） |
| 科技等级 | 3 |
| 标签 | `ingredient.vehicle.light_patrol_boats` |
